...
<?php if ( have_comments() ) : ?>
	<div class="comments-title">
		<h2>Comments | <span>discussion on &#8220;<?php the_title(); ?>&#8220;</span></h2>
		<h4 class="comments-count"><?php comments_number('No Responses', 'One Response', '% Responses' );?></h4>
	</div>
		...
		<?php else : ?>
			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="form-horizontal">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="author">Name <?php if ($req) echo "(required)"; ?></label>
					<div class="col-sm-7">
						<input type="text" name="author" id="author" class="form-control" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-sm-4" for="email">Mail (will not be published) <?php if ($req) echo "(required)"; ?></label>
					<div class="col-sm-7">
						 <input type="text" name="email" id="email" class="form-control" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="url">Comment</label>
					<div class="col-sm-8">
